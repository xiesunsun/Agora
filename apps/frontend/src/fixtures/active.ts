...
const bullets: Bullet[] = [
  {
    ...
    unitId: "u-shape",
    queueOrder: 0,
    createdAt: "2026-05-04T11:21:00.000Z",
    beforeText: "轮廓变得更清楚",
    afterText: "轮廓变得更清楚，并且更具体",
    title: "Development",
  ...
  },
  {
    ...
    unitId: "u-alongside",
    queueOrder: 1,
    createdAt: "2026-05-04T11:22:00.000Z",
    anchorTextSnapshot: "站在作者身旁",
    title: "Tone",
    body: "这句是整段的心脏，建议保留它的温度。",
    author: "Jun",
    railY: 26,
    content: "这句是整段的心脏，建议保留它的温度。",
  },
  {
    bulletId: "b-3",
    type: "comment",
    ...
    unitId: "u-posture",
    queueOrder: 2,
    createdAt: "2026-05-04T11:23:00.000Z",
    anchorTextSnapshot: "哪些地方需要安静",
    title: "Redundancy",
    body: "后续可以考虑合并重复的判断标准。",
    author: "Mia",
    railY: 38,
    content: "后续可以考虑合并重复的判断标准。",
  },
];
